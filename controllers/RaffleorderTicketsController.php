...
use app\models\RaffleorderTicketsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * RaffleorderTicketsController implements the CRUD actions for RaffleorderTickets model.
 */
class RaffleorderTicketsController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new RaffleorderTicketsSearch();
