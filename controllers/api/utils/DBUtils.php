...
class DbUtils
{
    ...
    public function __construct()
    {
        ...
        {
            CoreUtils::flog4php(2, NULL, array('PDOEXCEPTION: ' => $pdoe->getMessage(), 'MESSAGE' => 'A connection to the database server could not be established, processing cannot continue.exiting now...'), __FILE__, __FUNCTION__, __LINE__, "smsfatal", SMS_LOG_PROPERTIES);
        ...
        {
            CoreUtils::flog4php(2, NULL, array('EXCEPTION: ' => $e->getMessage(), 'MESSAGE' => 'An error occured while processing the request, processing cannot proceed.exiting now...'), __FILE__, __FUNCTION__, __LINE__, "smsfatal", SMS_LOG_PROPERTIES);
            $this->response['STATCODE'] = 7;
    ...
    public function query($query,$params = null)
    {
        ...
        try
        {
            ...
            if ($result) :
                ...
                CoreUtils::flog4php(3, NULL, array('REASON' => 'Empty set.'), __FILE__, __FUNCTION__, __LINE__, "smsfatal", SMS_LOG_PROPERTIES);
            endif;
    ...
    public function execute($query, $params = null)
    {
        try
        {
            ...
            if ($result) :
                ...
                CoreUtils::flog4php(3, NULL, array('ERROR' => $this->pdo->errorInfo()), __FILE__, __FUNCTION__, __LINE__, "smsfatal", SMS_LOG_PROPERTIES);
            endif;
