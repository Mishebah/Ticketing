...
$tat = sprintf("%.2f", microtime(true) - $starttime);
	...
	{
		if($this->response['SUCCESS'] ==true):
	$insertOutbound = "insert into outbound(transactionID,messageID,firstSend,lastSend,nextSend,sourceAddress,msisdn,resend,statusCode,gatewayUUID,dateCreated,updatedBy,accessCode,serviceID) values(?,?,null,null,now(),?,?,?,0,0,now(),?,?,?)";
